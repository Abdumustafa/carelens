...
import 'package:carelens/core/widget/radio_yes_or_no_colum.dart';
...
class DiabetesScreen3 extends StatelessWidget {
  const DiabetesScreen3({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            verticalSpace(50),
            QuestionTextWidget(
              text: ' Do you smoke or use any tobacco \n products? ',
            ),
            verticalSpace(30),
            YesNoRadiocolum(),
            Spacer(),
